  ...
  return (
    <main className="mx-auto max-w-2xl space-y-4 p-4">
      <header className="card flex items-center justify-between">
        ...
        <div className="flex gap-2"><Link href="/items/new" className="rounded-xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white dark:bg-white dark:text-slate-900">追加</Link><LogoutButton /></div>
      </header>
